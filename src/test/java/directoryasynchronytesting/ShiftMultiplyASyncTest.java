...
public class ShiftMultiplyASyncTest extends AbstractASyncDirectoryTesting{
    private static ASyncDirectoryProcessor directoryProcessor;

    @BeforeClass
    public static void before(){
        try {
            directoryProcessor = new ASyncDirectoryProcessor(getOriginalPath(), new ShiftMultiplyEncryption());
