...
public class ShiftUpASyncTest extends AbstractASyncDirectoryTesting{
    ...
    public static void before(){
        try {
            directoryProcessor = new ASyncDirectoryProcessor(getOriginalPath(), new ShiftUpEncryption());
