...
public class XorEncryptionASyncTest extends AbstractASyncDirectoryTesting{
    ...
    public static void before(){
        try {
            directoryProcessor = new ASyncDirectoryProcessor(getOriginalPath(), new XorEncryption());
