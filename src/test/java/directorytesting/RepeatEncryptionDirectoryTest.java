...
public class RepeatEncryptionDirectoryTest extends abstractDirectoryTestClass{
    ...
    public static void before(){
        try {
            directoryProcessor = new SyncDirectoryProcessor(getOriginalPath(), new RepeatEncryption(
