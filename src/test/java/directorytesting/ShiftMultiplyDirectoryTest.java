...
public class ShiftMultiplyDirectoryTest extends abstractDirectoryTestClass {
    ...
    public static void before(){
        try {
            directoryProcessor = new SyncDirectoryProcessor(getOriginalPath(), new ShiftMultiplyEncryption());
