...
public class ShiftUpDirectoryTest extends abstractDirectoryTestClass {
    ...
    public static void before(){
        try {
            directoryProcessor = new SyncDirectoryProcessor(getOriginalPath(), new ShiftUpEncryption());
